...
var config = require('./package'),
    ...
    mongoose = require('mongoose').connect('mongodb://localhost/'.concat(config.name), ( error ) => {
        if( error ) {
            ...
            console.info('the config.name is: ', config.name);
            console.info('the package name is: '.yellow, config.name);
    ...
    methodOverride = require('method-override'), //method override for CRUD
...
app.use(fileserver);
//=======================================================================================
// setup for method overriding during our CRUD operations
